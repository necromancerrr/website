...
export default function ResetPasswordConfirmPage() {
  ...
  useEffect(() => {
    ...
    async function validateToken() {
      try {
        const res = await fetch(`/api/admin/auth/reset-password/validate?token=${token}`);
      ...
      <div className="min-h-screen pt-24 px-4">
        <div className="max-w-md mx-auto">
          <div className="text-center py-20">
            ...
            <h1 className="text-xl font-medium text-white mb-2">Invalid Reset Link</h1>
      ...
      <div className="min-h-screen pt-24 px-4">
        <div className="max-w-md mx-auto">
          <div className="text-center py-20">
            ...
            <h1 className="text-xl font-medium text-white mb-2">Password Reset Successfully</h1>
      ...
      <div className="max-w-md mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-sm text-zinc-400">
            Setting new password for <span className="text-zinc-300">{email}</span>
          </p>
        </div>
